...
export const auctions: Auction[] = [
  {
    ...
    description: 'Beautiful vintage leather jacket in excellent condition. Perfect for fall.',
    images: [
  ...
  },
  {
    ...
    description: 'Elegant silk dress from a top designer. Perfect for special occasions.',
    images: [
  ...
  },
  {
    ...
    description: 'Rare limited edition sneakers, never worn. Original box included.',
    images: [
  ...
  },
  {
    ...
    description: 'Luxurious cashmere sweater in perfect condition. Very soft and warm.',
    images: [
  ...
  },
  {
    ...
    description: 'Classic denim jacket from the 90s. Great condition with subtle distressing.',
    images: [
