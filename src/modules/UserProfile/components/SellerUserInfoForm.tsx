...
import { usePutSeller } from "../service/CRUD-user";
import { yupResolver } from "@hookform/resolvers/yup";
import { userSchema, UserShemaFormData } from "../schema/user.schema";

interface SellerUserInfoFormProps {
  user: IUser;
  onClose?: () => void;
}

const SellerUserInfoForm: React.FC<SellerUserInfoFormProps> = ({
  user,
  onClose,
}) => {
  const { mutate: updateBuyer } = usePutSeller();
...
export default SellerUserInfoForm;
