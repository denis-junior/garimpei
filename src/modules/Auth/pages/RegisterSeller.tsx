...
const RegisterSellerPage: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-lg animate-in fade-in-0 duration-500 relative z-10">
        {/* Logo */}
        ...
        <div className="mt-4 sm:mt-6 text-center space-y-2 animate-in slide-in-from-bottom-4 duration-700 delay-300 px-2 sm:px-0">
          <p className="text-xs sm:text-sm text-white/90 drop-shadow-md">
            ...
            <span
              ...
              className="text-white font-medium hover:text-white/80 transition-colors hover:underline cursor-pointer drop-shadow-md"
            >
              Entrar
            </span>
          </p>
          <p className="text-xs text-white/80 drop-shadow-md">
            ...
            <a
              ...
              className="text-white hover:text-white/90 transition-colors hover:underline"
            >
